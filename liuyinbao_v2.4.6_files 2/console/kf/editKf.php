<?php
    ...
    if(isset($_SESSION["yinliubao"])){
    	...
    	// 定制功能-2025-03-22
        $kf_title_broswer = trim($_POST['kf_title_broswer']);
        $kf_hmbz = trim($_POST['kf_hmbz']);
        ...
        if(empty($kf_title) || !isset($kf_title)){
        ...
        }else if(empty($kf_title_broswer) || !isset($kf_title_broswer)){
            ...
            if($kf_creat_user == $LoginUser){
                ...
                $updatekfData = [
                    'kf_title' => $kf_title,
                    'kf_title_broswer'=>$kf_title_broswer,
                    'kf_hmbz'=>$kf_hmbz,
                    'kf_rkym' => $kf_rkym,
                    'kf_ldym' => $kf_ldym,
                    'kf_dlym' => $kf_dlym,
